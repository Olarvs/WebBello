        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                   <button type="button" class="flex: items-center justify-center focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" >Add New Resident</button>
            ...
            <div class="overflow-x-auto">
             ...
             <!-- COMMENTED THE PAGINATION FOR RESIDENT'S TABLE -->
...
<div id="updateProductModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="#" id ="updateResidentInformation">
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="#" id ="frmRegisterResident">
                    <div>
                    ...
                    <div>
                        <label for="role" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sex</label>
...
//table body
const residentsTblBody = document.querySelector('#residentsTblBody');
//form
const frmRegisterResident = document.querySelector('#frmRegisterResident')
...
const loadTable = async function(){
    //api
  const getUsers =  await fetch("../api/admin/all-residents.php");
  ...
  if(response.responseStatus === 'OK'){
    ...
    residentsTblBody.innerHTML = content;

  }
}//end of onload


frmRegisterResident.addEventListener('submit', async (event) =>{
    event.preventDefault()
    formData = new FormData(frmRegisterResident)
...
//fetch data
  const request =  await fetch("../api/admin/register-new-residents.php",{
    method: "POST",
    body:formData,
  });
...
updateResidentInformation.addEventListener('submit', async (event) =>{
    event.preventDefault()
    formData = new FormData(updateResidentInformation)
    // uncomment this to print all the content of formData
//     for (const [key, value] of formData.entries()) {
//   console.log(`${key}: ${value}`);
// }
...
//fetch data
const request =  await fetch("../api/admin/update-residents.php",{
    method: "POST",
    body:formData,
  });
...
const deleteModal = async (button) =>{
    ...
    const request =  await fetch("../api/admin/delete-residents.php",{
    method: "POST",
    body:formData,
    });
