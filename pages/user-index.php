...
<body>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">The
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="../images/family-logo-removebg-preview.png" alt="mockup">
            </div>
        </div>
    </section>
    <!-- END OF HERO SECTION -->
    ...
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="profile-modal">
                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                <span class="sr-only">Close modal</span>
            </button>
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">User Profile</h3>
                <form class="space-y-6" action="#" id="frmUserProfile">
                    <div>
                    ...
                    <button type="submit" class="w-full text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-blue-800">Save Changes</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Sign up today!
                </h2>
                <p class="text-gray-500 sm:text-xl dark:text-gray-400">Join the Palazzo Bello Home Owners who are
                    already using Web-Bello to improve community communication and foster stronger relationships with
                    their neighbors.</p>
            </div>
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Community Calendar</h3>
                    <p class="text-gray-500 dark:text-gray-400">Keep track of upcoming events and important dates with a
                        shared community calendar. From neighborhood block parties to HOA meetings, you'll never miss a
                        beat.</p>
                </div>
                <div>
                    <div
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Online Directory</h3>
                    <p class="text-gray-500 dark:text-gray-400"> Connect with your neighbors and build stronger
                        relationships through an online directory. Easily find contact information for other homeowners
                        and stay connected with your community.</p>
                </div>
                <div>
                    <div
                        class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Message Boards</h3>
                    <p class="text-gray-500 dark:text-gray-400">Share your thoughts and ideas with other homeowners
                        through message boards. Discuss neighborhood issues, recommend local businesses, and connect
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Photo Galleries</h3>
                    <p class="text-gray-500 dark:text-gray-400">Capture and share memories with your community through
                        photo galleries. From community events to holiday gatherings, relive the moments that make your
                        community special.</p>
                </div>
                <div>
                    <div
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Maintenance Requests</h3>
                    <p class="text-gray-500 dark:text-gray-400">Report any issues or maintenance requests directly to
                        your HOA through a dedicated platform. With a streamlined process, you can ensure timely
                        responses and efficient resolutions.</p>
                </div>
                <div>
                    <div
                        class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Resource Center</h3>
                    <p class="text-gray-500 dark:text-gray-400">Access important community documents and information
                        through a centralized resource center. From community guidelines to important updates,
                        everything you need is in one convenient location.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-screen-xl">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="#" class="flex items-center">
                        <!-- <img src="../images/logo-icon.png" class="h-20" alt="FlowBite Logo" /> -->
                        <span
                            class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Web-Bello</span>
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            <li class="mb-4">
                                <a href="https://flowbite.com" class="hover:underline">Web-Bello</a>
                            </li>
                            <li>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a
                        href="https://flowbite.com" class="hover:underline">Web-Bello™</a>. All Rights Reserved.
                </span>
