...
<section class="bg-white dark:bg-gray-900">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Welcome to Web-Bello!</h1>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">The ultimate hub for homeowners to stay connected and informed! With Web-Bello, you can easily connect with your neighbors, stay informed on the latest news and events, and receive important alerts and notifications.</p>
...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Sign up today!</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Join the Palazzo Bello Home Owners who are already using Web-Bello to improve community communication and foster stronger relationships with their neighbors.</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <p class="text-gray-500 dark:text-gray-400">Keep track of upcoming events and important dates with a shared community calendar. From neighborhood block parties to HOA meetings, you'll never miss a beat.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400"> Connect with your neighbors and build stronger relationships through an online directory. Easily find contact information for other homeowners and stay connected with your community.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">Share your thoughts and ideas with other homeowners through message boards. Discuss neighborhood issues, recommend local businesses, and connect with others in your community.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">Capture and share memories with your community through photo galleries. From community events to holiday gatherings, relive the moments that make your community special.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">Report any issues or maintenance requests directly to your HOA through a dedicated platform. With a streamlined process, you can ensure timely responses and efficient resolutions.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">Access important community documents and information through a centralized resource center. From community guidelines to important updates, everything you need is in one convenient location.</p>
          </div>
      </div>
  </div>
</section>
<footer class="p-4 bg-white sm:p-6 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com" class="hover:underline">Web-Bello™</a>. All Rights Reserved.
            </span>
